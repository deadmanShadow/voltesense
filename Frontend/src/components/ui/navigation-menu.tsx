/**
 * NavigationMenu — shadcn/ui primitive (Radix UI under the hood).
 *
 * Available for any future top-level nav. Not currently consumed by
 * VoltSense (sidebar handles nav today); installed so the primitive set
 * matches changesFrontend.md §1.
 *
